...
// Corrigez l'import en haut du fichier
...
const projects = [
  ...
  {
    title: 'Fuse',
    description: "Un mini jeu de simulateur de fusee",
    image: 'fuse.png',
    url: 'https://gheobechoco.github.io/fusee-js/'
  }, 
  {
    title: 'Redux Todo App',
    description: "Une application Todo utilisant Redux pour la gestion d'état",
    image: 'redux-todo.png',
    url: 'https://redux1-lilac.vercel.app/'
  }
];
          ...
          <Grid key={proj.title} item xs={12} sm={6} md={4}>
            ...
            >
              ...
              <CardContent>
                <Typography
                  variant="h6"
                  sx={{ color: '#64ffda', fontWeight: 600, mb: 1 }}
                >
                  {proj.title}
                </Typography>
